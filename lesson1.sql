...
-- 1. Получить список всех студентов с именем "Антон"
SELECT id, name_student, email, phone_number FROM students
WHERE name_student = 'Антон';

-- 2. Вывести имя и почту из таблички "Студент" по всем студентам
SELECT name_student, email FROM students;

-- 3. Выбрать информацию о студентах, имена которых начинаются с буквы «А».
